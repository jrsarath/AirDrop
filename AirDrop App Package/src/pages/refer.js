            ...
            <Screen>
                ...
                <ScrollView>
                    <View style={styles.header}>
                        ...
                        <Subtitle styleName='h-center' style={{color:'#fff', lineHeight:16,width:'80%'}}>Invite your friends to App install using your promo code and Easy Earn Rs. 30 /- when they join first contest and your friends also get Rs.10/- for SignUp. Invite more friends earn more money!</Subtitle>
                    </View>
