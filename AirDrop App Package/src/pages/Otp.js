...
export default class OtpScreen extends Component {
    ...
    _sendCode() {
        ...
        var url = 'https://api.msg91.com/api/sendhttp.php?mobiles='+this.props.navigation.getParam('phone')+'&authkey=232484AdRxzpQ4Rhk5b785182&route=4&sender=GMESTR&message=Hi Gamer. Please use OTP: '+code+' to verify your mobile number with Game Setter&country=91&response=json';
        fetch(url, {
            method: 'GET',
            headers: new Headers({
        ...
        return(
            <Screen style={{backgroundColor: '#fff'}}>
                <View style={styles.header}>
                    <Title style={{color:'#fff'}}>Mobile Verification</Title>
                </View>
                <ScrollView>
                    <View style={styles.container}>
                        <View style={styles.textCon}>
                            <Title style={{color:'#f44336'}}>Mobile No verification</Title>
                            <Subtitle style={{color:'#4a4a4a'}}>Please verify your mobile number to enjoy GameSetter with full benefits</Subtitle>
                        </View>                        
