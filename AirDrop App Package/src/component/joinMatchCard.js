...
class MatchCard extends Component {
    constructor(props){
        super(props);
        this.state = {
            action: () => +store.getState().bonus >= +this.props.data.entryfee ? this.props.navigation.navigate('joinMatch', {data: this.props.data}) : +store.getState().wallet >= +this.props.data.entryfee ? this.props.navigation.navigate('joinMatch', {data: this.props.data}) : this.props.navigation.navigate('Wallet')
        }
    }
    componentDidMount() {
        store.subscribe(()=> {
